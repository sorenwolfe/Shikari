...
$sources += @('ReplayAttempt','ReplayBuffer','ReplayValidation','ReplayEvidence','EvidenceTimeline','EvidenceRules','StrategyEnrichment','StrategyMergeSession' | ForEach-Object { "$root/Shikari/Services/Replay/$_.cs" })
