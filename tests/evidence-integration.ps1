...
$sources += @('ReplayAttempt','ReplayBuffer','ReplayValidation','ReplayEvidence','EvidenceTimeline','EvidenceRules','LogReplayBuilder' | ForEach-Object { "$root/Shikari/Services/Replay/$_.cs" })
...
$sources += "$root/Shikari/Services/FfLogs/LogModels.cs", "$root/Shikari/Services/FfLogs/LogEvidence.cs", "$PSScriptRoot/EvidenceIntegrationTests.cs"
