...
$sources += "$root/Shikari/Services/Adaptive/AdaptiveEngine.cs", "$root/Shikari/Services/PlanJson.cs", "$root/Shikari/Services/Live/WorldAlignment.cs", "$PSScriptRoot/StrategyEvidenceTests.cs"
$sources += "$root/Shikari/Services/ShareCode.cs", "$root/Shikari/Services/PlanNormaliser.cs"
...
[Shikari.Tests.StrategyEvidenceTests]::Run()
