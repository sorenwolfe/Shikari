...
$sources = "$root/Shikari/UI/BuddyLayout.cs", "$root/Shikari/UI/BuddyMotion.cs", "$root/Shikari/UI/BuddyBlink.cs", "$root/Shikari/UI/BuddyWindow.cs", "$root/Shikari/Services/Buddy/BuddyCueEngine.cs", "$root/Shikari/Services/Buddy/BuddyAmbientPresentation.cs", "$root/Shikari/UI/Theme/Palette.cs", "$PSScriptRoot/BuddyWindowHarness.cs"
