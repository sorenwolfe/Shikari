...
$sources += "$root/Shikari/Services/Live/WorldAlignment.cs", "$root/Shikari/Services/Adaptive/AdaptiveEngine.cs", "$PSScriptRoot/ReplayIntegrationStubs.cs", "$PSScriptRoot/ReplayBackgroundTests.cs", "$PSScriptRoot/ReplayLibraryFailureTests.cs"
...
try { [Shikari.Tests.ReplayIntegration]::RunLibraryFailures($testDirectory) }
finally {
