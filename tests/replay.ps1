...
$sources += "$root/Shikari/Services/Replay/RecordedCast.cs", "$root/Shikari/Services/Replay/ReplayAttempt.cs", "$root/Shikari/Services/Replay/ReplayBuffer.cs", "$root/Shikari/Services/Replay/ReplayPlayback.cs"
